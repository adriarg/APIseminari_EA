...
import subjectroutes from './modules/subjects/subjects_routes.js'; // afegeixo les rutes dels subjects
...
const swaggerOptions = {
    definition: {
        ...
        tags: [
            ...
            {
              name: 'Subjects',
              description: 'Rutes dels subjects',   
            }
          ],
        servers: [
            {
    ...
    apis: ['./modules/users/*.js', './modules/forum/*.js', './modules/subjects/*.js'] // Incloc els arxius de les rutes
};
...
//mongoose;
mongoose
    .connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/Seminari5') // canvio la direccio a la meva
